...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="MUeJukkMH1"><RenderMd content={`\`\`\`Bash
...
<Tabs.TabPane title="Python" key="xuYR35kzxj"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="YPEgQxaF7t"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="tdFPJhTYxS"><RenderMd content={`\`\`\`java
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="nhWgJtRt1Q"><RenderMd content={`\`\`\`Python
import asyncio
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="RPBrMXsquI"><RenderMd content={`\`\`\`Python
import asyncio
import os
from volcenginesdkarkruntime import AsyncArk
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="JFTcRxpPmP"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="vO3g9Fl5T8"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="t3edZvwHjL"><RenderMd content={`\`\`\`java
